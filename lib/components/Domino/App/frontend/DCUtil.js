var DCUtil = {
    ...
    getParentTag: function( node, tag ) {
        var cnode = node;
        while( cnode ) {
            if( cnode && cnode.parentNode && cnode.tagName === tag ) {
                return cnode;
            }
    ...
    getParentAttr: function( node, attr ) {
        var cnode = node;
        while( cnode ) {
            if( cnode && cnode.parentNode && cnode.hasAttribute( attr ) ) {
                return cnode;
            }
